...
function Navigation(props) {
    return(
        <div className="nav-bar">
            <DropdownButton id="dropdown-item-button" title="Algorithm">
            ...
            <div>
                <Button variant="primary" onClick={props.refresh}>Reset</Button>{' '}
                <Button variant="secondary" onClick={props.run}>Run</Button>
            </div>
        </div>
    );
}
